...
const Sidebar = () => {
    ...
    return (
        ...
        text-white ${selectedUser ? "mx-md:hidden" : ''}`}>
            <div className='pb-5'>
                <div className='flex justify-between items-center px-4 py-2'>
                    ...
                    <div className='relative py-2 group'>
                        ...
                        cursor-pointer' />
                        <div className='absolute top-full right-0 z-20 w-32 p-5rounded-md bg-[#2821412]
                ...
                <div className='bg-[#282142] rounded-full flex items-center gap-2 py-3 px-4 mt-5'>
                    ...
                    <input onChange={(e) => setInput(e.target.value)} type="text" className='bg-transparent
