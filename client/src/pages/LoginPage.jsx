...
const LoginPage = () => {
  ...
  const [isDataSubmitted, setIsDataSubmitted] = React.useState("");
  ...
  return (
    ...
    justify-center gap-8 sm:justufy-evenly max-sm:flex-col backdrop-blur-2xl'>
      ...
      p-6 flex flex-col gap-6 rounded-lg shadow-lg'>
        ...
        {!isDataSubmitted && (
          <>
            <input onChange={(e) => setEmail(e.target.value)} value={email}
              ...
              className='p-2 border border-gray-500 rounded-md focus:eing-indigo-500' />
        ...
        {currState === "Sign Up" && isDataSubmitted && (
          <textarea onChange={(e) => setBio(e.target.value)} value={bio}
            ...
            focus:eing-indigo-500' placeholder='provide a short bio...' required ></textarea>
        )
        }
